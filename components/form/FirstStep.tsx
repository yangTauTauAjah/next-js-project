...
export default function() {
  return (<form onSubmit={e => e.preventDefault()} className='flex flex-col justify-between w-auto my-5 mx-auto'>
  ...
  <div className='self-end'>
    <button type='submit' className='px-7 py-3 bg-[#03295A] hover:bg-[#174A8B] text-white rounded-lg'>Next Step</button>
  </div>
  </form>)
}