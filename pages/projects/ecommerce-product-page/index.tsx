...
export default function () {
  ...
  return (
    <div
      className="md:mx-auto md:max-w-[1112px]"
      style={{ fontFamily: "Kumbh Sans", color: "black" }}
    >
      <header
      ...
      >
        ...
        <div className="flex gap-5 items-center md:gap-9">
          ...
          <div>
            <Image
              className={`rounded-full cursor-pointer w-auto h-8 hover:border-2 hover:border-[#FF7d1A]
              md:h-12`}
              src={Avatar}
              width={Avatar.width}
